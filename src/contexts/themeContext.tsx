import { createContext, useContext, useState, useLayoutEffect, ReactNode, FunctionComponent, useEffect } from "react";
...
const ThemeProvider: FunctionComponent<ThemeProviderProps> = ({ children }) => {
    ...
    return <ThemeContext.Provider value={{ theme, toggleTheme, sidebarCollapseState, toggleSidebarState }}>{children}</ThemeContext.Provider>;
};
